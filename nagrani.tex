...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{2}, 27--30 (2026)}
...
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{2}, 27--30 (2026)}
\fancyfoot[C]{\thepage}
}
...
\section{Results}
\Cref{tab:3} gives the measured fall times for kickball and baseball. A summary of these data is given in \cref{tab:4} and \cref{fig:3}.

\begin{table}
\caption{Fall times (\unit{\second}) for the kickball and baseball across five trials, including timing measurements from two individuals.}
\label{tab:3}
\end{table}
...
\begin{figure}
\caption{Bar chart of fall times for kickball and baseball. Differences are not significant (stats blurbage here).}
\label{fig:2}
\end{figure}

\begin{figure}
\caption{Bar chart of $g$ estimates for kickball and baseball. Differences are not significant (stats blurbage here).}
\label{fig:3}
\end{figure}
